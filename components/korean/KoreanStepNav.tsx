...
import { KOREAN_STEP_LABELS } from "@/lib/korean-types";
            ...
            >
              <motion.div
                ...
                className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center text-lg transition-all duration-300 border-2 ${
                  isActive
                    ? "bg-indigo-500 text-white border-indigo-500 shadow-lg shadow-indigo-500/40 ring-4 ring-indigo-500/20"
                    : isPast
                    ? "bg-emerald-500 text-white border-emerald-500 shadow-md shadow-emerald-500/20"
                    : "bg-white dark:bg-gray-800 text-gray-400 border-gray-200 dark:border-gray-700 group-hover:border-indigo-300 dark:group-hover:border-indigo-600"
                }`}
              >
                {isPast ? (
                  <motion.span
