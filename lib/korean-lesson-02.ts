    ...
    points: [
      {
        ...
        meaning: "本课学习10个常用基础辅音。其中ㄱ ㄷ ㅂ ㅅ ㅈ属于松音；ㄴ ㄹ ㅁ ㅇ属于响音，ㅎ是喉部摩擦音。\n\nㄱ、ㄷ、ㅂ、ㅅ、ㅈ要与后续学习的送气音和紧音对比练习，不能把全部基础辅音都统称为松音。",
      ...
      },
      {
        ...
        meaning: "拼合方式取决于元音主干方向：\n• 竖形元音（ㅏ ㅑ ㅓ ㅕ ㅣ）：辅音在左，元音在右\n• 横形元音（ㅗ ㅛ ㅜ ㅠ ㅡ）：辅音在上，元音在下",
