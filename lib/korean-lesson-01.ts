...
export const koreanLesson01Data: KoreanLesson = {
  ...
  input: {
    ...
    vocabulary: [
      ...
      { korean: "이에요", chinese: "是（敬语）", romanization: "ieyo", partOfSpeech: "形容词" },
  ...
  analysis: {
    commonErrors: [
      ...
      {
        wrong: "把ㅚ读成中文的'外'",
        correct: "ㅚ现代多读作[we]，类似'we'但口型更圆",
        reason: "传统发音[ø]已很少使用，但教材常保留旧标注。",
      },
      {
        wrong: "ㅐ和ㅔ发成完全不同的音",
        correct: "现代韩语中ㅐ和ㅔ几乎同音，都读[ɛ]",
        reason: "年轻一代已不区分，但书写时仍需注意区别。",
      },
    ],
    keyQuestions: [
      "为什么ㅇ在音节开头不发音？",
