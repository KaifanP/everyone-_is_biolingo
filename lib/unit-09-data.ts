...
export const unit09Data: UnitData = {
  ...
  analysis: {
    commonErrors: [
      ...
      {
        title: "will 后直接接 can",
        wrong: "I <strong>will can help</strong> you tomorrow.",
        correct: "I <strong>will be able to</strong> help you tomorrow.",
        reason: "will 后不能再接情态动词 can。注意：can 本身可以在有明确将来时间的语境中使用，如 I can help you tomorrow。",
      },
      {
        title: "把may当作过去许可形式",
        wrong: "<strong>May</strong> I leave yesterday?",
        correct: "<strong>Was I allowed to</strong> leave yesterday?",
        reason: "may 可以让请求显得更正式，但它不是 can 的过去时。表达过去是否获准，通常用 was/were allowed to。",
      },
    ],
    keyQuestions: [
      "这个情态动词表达的是什么含义？（能力/许可/推测/义务）",
      "需要哪种时间表达？can 可带将来时间；will 后则用 be able to",
      "是什么场合？（正式/非正式）",
    ],
    stateVerbs: {
      categories: [
  ...
  practice: [
    {
      ...
      items: [
        ...
        { question: "By the end of the course, I ______ use the software independently.", answer: "will be able to" },
    ...
    },
    {
      ...
      items: [
        ...
        { question: "May I leave yesterday?", answer: "<strong>Was I allowed to</strong> leave yesterday?（过去是否获准用 was/were allowed to）" },
        { question: "I will can help you tomorrow.", answer: "I <strong>will be able to</strong> help you tomorrow.（will 后不能接 can）" },
      ],
    },
  ],
  production: [
  ...
  summary: {
    keyPoints: [
      ...
      {
        title: "表示能力",
        items: ["can：现在能力，也可在语境明确时表示将来可行性", "could：过去一般能力", "be able to：可用于更多时态结构", "was able to：强调过去某次成功做到"],
      },
      {
        title: "表示许可",
